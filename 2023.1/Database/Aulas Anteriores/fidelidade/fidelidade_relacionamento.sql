...
CREATE TABLE `relacionamento` (
  ...
  `cpnjC` varchar(20) NOT NULL,
  `cpnjR` varchar(20) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `cpnjC` (`cpnjC`),
  KEY `cpnjR` (`cpnjR`),
  CONSTRAINT `relacionamento_ibfk_1` FOREIGN KEY (`cpnjC`) REFERENCES `clientes` (`cpnjC`),
  CONSTRAINT `relacionamento_ibfk_2` FOREIGN KEY (`cpnjR`) REFERENCES `revendedores` (`cpnjR`)
